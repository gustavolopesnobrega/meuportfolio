        ...
        <div className=" bg-zinc-200 rounded-md flex flex-col p-6 max-w-xs md:max-w-sm lg:max-w-sm ">
            ...
            <div className="flex flex-col gap-2">
                ...
                <div className="flex gap-5 lg:justify-center py-6 text-sm lg:text-md ">
                    <Link href={"https://cimconfederazione.it/"} target="_blank" className=" bg-black flex gap-2 hover:bg-dots-blue ease-in duration-150 p-2 rounded-md text-white md:p-3"><AiOutlineEye className="mt-1"></AiOutlineEye>View project</Link>
                    <Link href={"https://github.com/gustavolopesnobrega/CIM"} target="_blank" className=" bg-black  hover:bg-dots-blue ease-in duration-150 p-2 rounded-md text-white md:p-3"> Github repositorio</Link>
                </div>
            </div>
        </div>
